...
//uint8_t colPins[8]={A3,A2,A1,A0,13,12,11,10};
//uint8_t rowPins[8]={ 2, 3, 4, 5, 6, 7, 8, 9};

//uint8_t colPins[8]={A3,A2,A1,A0,13,12,11,10};
//uint8_t rowPins[8]={ 9, 8, 7, 6, 5, 4, 3, 2};

uint8_t rowPins[8]={10,11,12,13,A0,A1,A2,A3};
uint8_t colPins[8]={ 9, 8, 7, 6, 5, 4, 3, 2};

//uint8_t colPins[8]={10,11,12,13,A0,A1,A2,A3};
//uint8_t rowPins[8]={ 2, 3, 4, 5, 6, 7, 8, 9};
